    ...
    <section className={`mb-5`}>
      <div className="container">
        <div className="row d-block">
          ...
          >
            <img className="col-md-1 col-3" src={logo1} alt="logo" />
            <img className="col-md-1 col-3" src={logo2} alt="logo" />
            <img className="col-md-1 col-3" src={logo3} alt="logo" />
            <img className="col-md-1 col-3" src={logo4} alt="logo" />
            <img className="col-md-1 col-3" src={logo5} alt="logo" />
            <img className="col-md-1 col-3" src={logo6} alt="logo" />
            <img className="col-md-1 col-3" src={logo7} alt="logo" />
            <img className="col-md-1 col-3" src={logo8} alt="logo" />
          </div>
        </div>
      </div>
    </section>
